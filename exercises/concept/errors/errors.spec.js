...
describe('errors', () => {
  describe('checkHumidityLevel', () => {
    ...
    xtest('should not throw if the humidity level is 53', () => {
  ...
  describe('reportOverheating', () => {
    ...
    xtest('should throw an ArgumentError if the temperature is null', () => {
      expect(() => reportOverheating(null)).toThrow(ArgumentError);
    });

    xtest('should throw an OverheatingError if the temperature is 501°C', () => {
  ...
  describe('monitorTheMachine', () => {
    ...
    xtest('should call only the alertDeadSensor if the check throws an ArgumentError', () => {
    ...
    xtest('should call only the shutdown action if the check throws an OverheatingError with a temperature equals to 651°C', () => {
      actions.check = jest.fn(() => {
    ...
    xtest('should call only the alertOverheating if the check throws an OverheatingError with a temperature of 530°C', () => {
      actions.check = jest.fn(() => {
    ...
    xtest('should rethrow the error if the check throws an unknown error', () => {
