...
describe('Prism', () => {
  ...
  xtest('upward refraction two hits', () => {
    const start = { x: 0, y: 0, angle: 0 };
    const prisms = [
  ...
  xtest('downward refraction two hits', () => {
    const start = { x: 0, y: 0, angle: 0 };
    const prisms = [
  ...
  xtest('multiple prisms floating point precision', () => {
  ...
  xtest('complex path with multiple prisms floating point precision', () => {
